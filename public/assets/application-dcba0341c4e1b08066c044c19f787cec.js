...
window.CountDownTimer = (function() {
  ...
  CountDownTimer.prototype.numberPath = function(i) {
    return this.imagePathPrefix + "/" + i + ".png";
  };
  ...
  CountDownTimer.prototype.preloadImages = function() {
    var i, img, j, results;
    img = new Image();
    results = [];
    for (i = j = 0; j <= 9; i = ++j) {
      results.push(img.src = this.numberPath(i));
    }
    return results;
  };
  ...
  CountDownTimer.prototype.createElements = function() {
    ...
    for (j = 0, len = ref.length; j < len; j++) {
      ...
      if (section !== 'seconds') {
        this.el.append($("<img>", {
          src: this.imagePathPrefix + "/fg-separator.png"
        }));
      }
    }
    return this.updateCountDown();
  ...
  CountDownTimer.prototype.write = function(section, number) {
    ...
    if (hundreds !== 0) {
      sectionElement.append($("<img>", {
        src: this.numberPath(hundreds)
      }));
    }
    sectionElement.append($("<img>", {
      src: this.numberPath(tens)
    }));
    return sectionElement.append($("<img>", {
      src: this.numberPath(ones)
    }));
  };
